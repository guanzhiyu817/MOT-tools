...
# Converts a text file containing information about the ground-truth to an image.
def txt2img(visual_path="visual_val_gt"):
    ...
    gt_json_path = 'datasets/MOT17/annotations/val_half.json'
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            txt_path = 'datasets/MOT17/train/' + show_video_name + '/gt/gt_val_half.txt'
...
# Convert the generated image sequence to a video file.
